...
{
	hlUInt uiWidth = 0, uiHeight = 0, uiPaletteSize = 0; // Normally we would not need to define them to 0. But GCC might give out a warning.
...
hlBool CWADFile::GetImageData(const CDirectoryFile *pFile, hlUInt &uiWidth, hlUInt &uiHeight, hlByte *lpPaletteData, hlByte *lpPixelData)
{
	...
	hlUInt uiPaletteSize = 0; // Normally we would not need to define it to 0. But GCC might give out a warning.
