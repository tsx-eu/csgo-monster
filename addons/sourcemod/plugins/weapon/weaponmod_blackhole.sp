...
char g_szVModel[PLATFORM_MAX_PATH] =	"models/dh/weapons/v_blackhole.mdl";
char g_szWModel[PLATFORM_MAX_PATH] =	"models/dh/weapons/w_blackhole.mdl";
int g_cModel;
...
public void OnLibraryAdded(const char[] sLibrary) {
	if( StrEqual(sLibrary, "CWM-CORE") ) {
		...
		CWM_AddAnimation(id, WAA_Attack, 	3,  27, 30);
		CWM_AddAnimation(id, WAA_Attack, 	4,  27, 30);
		CWM_AddAnimation(id, WAA_Attack2, 	5,  30, 40);
